...
const Dropdown = ({ trigger, defaultOpen, align = "end" }: Props) => {
  return (
    <DropdownMenu defaultOpen={defaultOpen}>
      ...
      <DropdownMenuContent
        align={align}
        className="w-fit rounded-md data-open:slide-in-from-bottom-20! data-closed:slide-out-to-bottom-20 data-open:fade-in-0 data-closed:fade-out-0 data-closed:zoom-out-100 duration-200 mx-2"
      >
        <DropdownMenuGroup>
          {/* User Info */}
